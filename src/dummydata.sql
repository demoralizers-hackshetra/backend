...
(1, 1, 1, '2022-02-01 09:00:00', 1, 'physical', 'scheduled', 'Headache', 1),
(2, 2, 2, '2022-02-02 09:00:00', 5, 'virtual', 'scheduled', 'Acne', 2),
(3, 3, 3, '2022-02-03 09:00:00', 7, 'physical', 'scheduled', 'Stomach pain', 3),
(4, 4, 4, '2022-02-04 09:00:00', 9, 'virtual', 'scheduled', 'Chest pain', 4);

NSERT INTO Tokens (doctor_id, patient_id, appointment_type, appointment_date, token_number, status, prescription) VALUES
(1, 5, 1, '2022-02-01 10:00:00', 1, 'scheduled', 'Take 2 tablets of Paracetamol twice a day'),
(2, 6, 2, '2022-02-02 10:00:00', 2, 'scheduled', 'Apply Benzoyl Peroxide cream on affected area twice a day'),
(3, 7, 3, '2022-02-03 10:00:00', 3, 'scheduled', 'Take Omeprazole before meals for a week'),
(4, 8, 4, '2022-02-04 10:00:00', 4, 'scheduled', 'Take Asprin and Nitroglycerin as directed');
